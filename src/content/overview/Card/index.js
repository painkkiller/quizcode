      ...
      <Grid item xs={12} md={4} sm={6}>
         <Card sx={{ maxWidth: 345 }} >
            <CardHeader
               action={
                  <IconButton aria-label="settings" sx={{
                     ...
                     {finished ? <CheckCircleOutlineIcon color='success' /> : <PanoramaFishEyeIcon color='black' />}
                  </IconButton>
               }
               title={title}
               subheader={type}
            ...
            <CardContent sx={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
               ...
               <Typography vairant="body2" sx={{ fontWeight: 'bold', fontStyle: 'oblique', letterSpacing: 1 }}>
