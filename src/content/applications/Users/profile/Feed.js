...
function Feed() {
  const feed = [
    ...
    },
    {
      ...
      company: 'Buzzdog',
      avatar: '/quizcode/static/images/avatars/2.jpg'
    },
    {
      name: 'Rowena Geistmann',
      jobtitle: 'Pharmacist',
      company: 'Yozio',
      avatar: '/quizcode/static/images/avatars/3.jpg'
    },
    {
      name: 'Ede Stoving',
      jobtitle: 'VP Operations',
      company: 'Cogibox',
      avatar: '/quizcode/static/images/avatars/4.jpg'
    },
    {
      name: 'Crissy Spere',
      jobtitle: 'Social Worker',
      company: 'Babbleblab',
      avatar: '/quizcode/static/images/avatars/5.jpg'
    },
    {
      name: 'Michel Greatbanks',
      jobtitle: 'Research Assistant III',
      company: 'Aimbu',
      avatar: '/quizcode/static/images/avatars/6.jpg'
    }
  ];
